...
<div class="bg-surface-container-low/30 border border-outline-variant/10 p-8 rounded-xl space-y-8">
  <div class="flex items-center justify-between">
    <h3 class="text-lg font-semibold flex items-center gap-3"><Papicon icon="List" size={20} class="text-primary" /> État des fonctionnalités</h3>
    ...
    {#each groupedFeatures as group}
      <div class="space-y-4">
        <div class="flex items-center gap-3">
          ...
          <span class="text-[10px] font-semibold uppercase tracking-wider text-on-surface-variant/30">{group.category}</span>
          <div class="h-[1px] flex-1 bg-outline-variant/10"></div>
        </div>
