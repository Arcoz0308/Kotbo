...
const algos = [
  ...
  // Types de défis variés
  { title: "Debug: Tri cassé", difficulty: "moyen", language: "fr", description: "Déboguez cet algorithme de tri qui oublie des éléments lors des swaps. Corrigez la logique sans réécrire tout le code.", solution: "Corriger la boucle interne pour qu'elle s'arrête à n-i-1 et conserver l'élément temporaire pendant le swap." },
  { title: "Code Golf: Somme minimale", difficulty: "moyen", language: "fr", description: "Retournez la somme des entiers d'un tableau en le moins de caractères possible. Bonus implicite: plus court est mieux.", solution: "a=>a.reduce((x,y)=>x+y,0)" },
  { title: "Contrainte absurde: Sans la lettre e", difficulty: "difficile", language: "fr", description: "Écrivez une fonction qui inverse une chaîne sans utiliser la lettre 'e' dans votre code (noms de variables inclus).", solution: "Utiliser des identifiants sans 'e' et une boucle d'index inversée." },
  { title: "Complexité temps: Top K fréquent", difficulty: "difficile", language: "fr", description: "Trouvez les K éléments les plus fréquents en mieux que O(n log n). Indiquez clairement la complexité temporelle visée.", solution: "Compter avec HashMap puis bucket sort en O(n)." },
  { title: "Complexité espace: Rotation in-place", difficulty: "moyen", language: "fr", description: "Faites une rotation d'un tableau vers la droite de k positions avec O(1) mémoire supplémentaire (in-place).", solution: "Méthode reverse en 3 étapes: reverse total, reverse préfixe, reverse suffixe." },
  { title: "Langage imposé: Kotlin obligatoire", difficulty: "moyen", language: "fr", description: "Résolvez le problème en Kotlin uniquement: vérifier si deux chaînes sont isomorphes.", solution: "Maintenir deux maps de correspondance bidirectionnelle entre caractères." },
