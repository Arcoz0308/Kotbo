-- Système d'accueil personnalisé : thread de bienvenue scénarisé.
-- Messages envoyés via webhook (nom/avatar personnalisables par message, intervalle
-- avec indicateur de frappe) puis embed d'accueil avec menu de présentation
-- (boutons ou menu déroulant ouvrant des pages embed).

-- CreateTable
CREATE TABLE "welcome_thread_configs" (
...
-- CreateTable
CREATE TABLE "welcome_thread_steps" (
    "id" TEXT NOT NULL,
    "guildId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "welcome_menu_pages" (
    "id" TEXT NOT NULL,
    "guildId" TEXT NOT NULL,
    "order" INTEGER NOT NULL DEFAULT 0,
    "label" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "welcome_thread_steps_guildId_order_idx" ON "welcome_thread_steps"("guildId", "order");

-- CreateIndex
CREATE INDEX "welcome_menu_pages_guildId_order_idx" ON "welcome_menu_pages"("guildId", "order");
