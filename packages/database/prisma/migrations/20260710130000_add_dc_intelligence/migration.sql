-- Migration: intelligent double-account detection support tables

-- Voice session timeline (for presence-alternation detection)
...
-- Labeled detection samples (learning loop / calibration dataset)
...
-- Foreign keys
ALTER TABLE "dc_voice_sessions" ADD CONSTRAINT "dc_voice_sessions_guildId_fkey" FOREIGN KEY ("guildId") REFERENCES "Guild"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "dc_detection_samples" ADD CONSTRAINT "dc_detection_samples_guildId_fkey" FOREIGN KEY ("guildId") REFERENCES "Guild"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "dc_signal_weights" ADD CONSTRAINT "dc_signal_weights_guildId_fkey" FOREIGN KEY ("guildId") REFERENCES "Guild"("id") ON DELETE CASCADE ON UPDATE CASCADE;
